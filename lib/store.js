...
async function createBooking(b) {
  if (isPg) {
    await pool.query(
      `INSERT INTO bookings (id,listing_id,listing_title,name,phone,duration,message,status,created_at)
       VALUES ($1,$2,$3,$4,$5,$6,$7,$8,$9)`,
      [b.id, b.listingId, b.listingTitle, b.name, b.phone,
       b.duration || '', b.message || '', b.status || 'pending', b.createdAt || Date.now()]
    );
    return b;
  }
  const data = db.read();
